      ...
      <Container style={{ backgroundColor: '#fdfdfd' }}>
        ...
        <ScrollView contentContainerStyle={{ flexGrow: 1 }}>
          <View style={{ flex: 1, justifyContent: 'center', alignItems: 'center', paddingLeft: 50, paddingRight: 50 }}>
            ...
            <Item>
              <Icon active name='ios-mail' style={{ color: '#687373' }} size={20} />
            ...
            <Item>
              <Icon active name='ios-man' style={{ color: '#687373' }} size={20} />
            ...
            <View style={{ alignItems: 'center' }}>
              <Button onPress={() => this.signup()} style={{ backgroundColor: Colors.navbarBackgroundColor, marginTop: 20, width: 95, justifyContent: 'center' }}>
