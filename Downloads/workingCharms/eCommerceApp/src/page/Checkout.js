...
export default class Checkout extends Component {
  ...
  render() {
    // console.log('total cart', this.state.total)
    // console.log('from checkout ', this.props.cartItems)
    var left = (
      <Left style={{ flex: 1 }}>
        ...
        <Content padder>
          <TouchableHighlight onPress={() => Actions.login()}>
            <View style={{ flex: 1, alignItems: 'center', backgroundColor: '#6fafc4', paddingTop: 20, paddingBottom: 20 }}>
              <Icon name="ios-warning" size={20} style={{ color: 'rgba(253, 253, 253, 0.9)', marginRight: 20, position: 'absolute', left: 11, top: 15, borderRightWidth: 1, borderColor: 'rgba(253, 253, 253, 0.2)', paddingRight: 10 }} />
          ...
          <View style={{ marginTop: 10, marginBottom: 10, paddingBottom: 7 }}>
            <Button onPress={() => this.checkout()} style={{ backgroundColor: Colors.navbarBackgroundColor }} block iconLeft>
              <Icon name='ios-card' size={20} style={{ marginRight: 10 }} />
  ...
  checkout() {
    ...
    alert("All the details has been sent to log");
  }
