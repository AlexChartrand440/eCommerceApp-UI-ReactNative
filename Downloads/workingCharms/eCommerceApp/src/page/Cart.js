...
import { Container, Content, View, Button, Left, Right, Body, Title, List, ListItem, Thumbnail, Grid, Col } from 'native-base';
            ...
            <Grid style={{ marginTop: 20, marginBottom: 10 }}>
              ...
              <Col style={{ paddingLeft: 5, paddingRight: 10 }}>
                <Button onPress={() => this.removeAllPressed()} style={{ borderWidth: 1, borderColor: Colors.navbarBackgroundColor }} block iconRight transparent>
                  ...
                  <Icon style={{ color: Colors.navbarBackgroundColor, marginLeft: 10 }} name='ios-trash' size={20} />
                </Button>
              </Col>
            </Grid>
          </Content>
